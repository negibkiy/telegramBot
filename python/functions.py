...
def choice_osn_podrazdeleniya(choice_podrazdelenie, message):        # функция для выбора основных подразделений
    ...
    elif choice_podrazdelenie == '📕 Библиотека':    # если выбрана "Спорт"
    ...
    elif choice_podrazdelenie == '💸 Профком':    # если выбрана "Спорт"
    ...
    # if choice_podrazdelenie == '⬆️ В главное меню' or choice_info == '⬆️ В главное меню' or message.text == '⬆️ В главное меню' or message.text == '/start' or  message.text== '⬅️ Назад':          # выполняется переход в главное меню
    else:
        return 0
...
def choice_tRas_tExm(choice_table, message):
    ...
    # if message.text == '⬆️ В главное меню' or choice_table == '⬆️ В главное меню' or choice_kurs == '⬆️ В главное меню' or message.text == '/start' or message.text== '⬅️ Назад':          # выполняется переход в главное меню
    else:
        return 0
